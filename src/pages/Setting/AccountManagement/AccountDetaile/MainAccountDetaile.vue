<template>
  <div class="wrap">
    ...
    <div class="con con01">
      <p class="con-title">사업자 정보</p>
      <ul>
        <li>
          <label for="con01-1" class="input-box">상호명</label>
          <input
            type="text"
            id="con01-1"
            placeholder="메인 계정명00001"
            disabled
          />
        </li>
        <li>
          <label for="con01-2" class="input-box">사업자등록번호</label>
          <input type="text" id="con01-2" placeholder="123-45678-90" disabled />
        </li>
        <li>
          <label for="con01-3" class="con01-3">비밀번호</label>
          <button class="button-box" @click="goAccountChangMainPw">
            비밀번호 변경
          </button>
        </li>
        <li>
          <label for="con01-4" class="input-box">업종</label>
          <input type="text" id="con01-4" placeholder="디지털미디어" disabled />
        </li>
        <li>
          <label for="con01-5" class="input-box">업태</label>
          <input type="text" id="con01-5" placeholder="디지털미디어" disabled />
        </li>
        <li>
          <label for="con01-6" class="input-box">주소</label>
          <input type="text" id="con01-6" placeholder="서울 양천구" disabled />
        </li>
      </ul>
    </div>
    <div class="con con02">
      <p class="con-title">대표자 정보</p>
      <ul>
        <li>
          <label for="con02-1" class="input-box">대표자명</label>
          <input type="text" id="con02-1" placeholder="홍길동" disabled />
        </li>
        <li>
          <label for="con02-2" class="input-box">전화번호</label>
          <input
            type="text"
            id="con02-2"
        ...
        <li>
          <label for="con02-3" class="input-box">대표자 E-mail</label>
          <input
            type="text"
            id="con02-3"
...
function goAccountChangMainPw() {
  router.push('/setting/account/changpw/main');
}
